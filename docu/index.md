...
* Installed plugin version: <em id='gerrit-gitblit-current-version'>3.3.171.0-SNAPSHOT</em> &mdash; <a id='gerrit-gitblit-version-check' style='display:none;' href='#'>Check for updates</a>
...
<a href="https://github.com/tomaswolf/gerrit-gitblit-plugin" target="_blank">GitBlit plugin 3.3.171.0-SNAPSHOT</a>
</div>
