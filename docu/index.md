...
This plugin integrates [GitBlit](https://github.com/gitblit/gitblit) **1.8.0** as a repository browser into [Gerrit](https://code.google.com/p/gerrit/),
...
* Installed plugin version: <em id='gerrit-gitblit-current-version'>3.10.171.0-SNAPSHOT</em> &mdash; <a id='gerrit-gitblit-version-check' style='display:none;' href='#'>Check for updates</a>
...
<a href="https://github.com/tomaswolf/gerrit-gitblit-plugin" target="_blank">GitBlit plugin 3.10.171.0-SNAPSHOT</a>
</div>
